<?php
/**
 * This file contains the Collector class
 */
 ...
 * Class Collector
 *
 * Custom PHRoute RouteCollector, based on original code
 *
 * @package Charm\Vivid\Router
 */
class Collector implements RouteDataProviderInterface
{
    /**
     *
     */
    ...
    public function addRoute($httpMethod, $route, $handler, array $filters = [])
    {
        ...
        [$routeData, $reverseData] = $this->routeParser->parse($route);
